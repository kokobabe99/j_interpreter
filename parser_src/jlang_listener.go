...
type JLangListener interface {
	...
	// EnterPanicStmt is called when entering the panicStmt production.
	EnterPanicStmt(c *PanicStmtContext)
	...
	// EnterMakeExpr is called when entering the makeExpr production.
	EnterMakeExpr(c *MakeExprContext)
	...
	// ExitPanicStmt is called when exiting the panicStmt production.
	ExitPanicStmt(c *PanicStmtContext)
	...
	// ExitMakeExpr is called when exiting the makeExpr production.
	ExitMakeExpr(c *MakeExprContext)
