...
// EnterPanicStmt is called when production panicStmt is entered.
func (s *BaseJLangListener) EnterPanicStmt(ctx *PanicStmtContext) {}

// ExitPanicStmt is called when production panicStmt is exited.
func (s *BaseJLangListener) ExitPanicStmt(ctx *PanicStmtContext) {}
...
func (s *BaseJLangListener) EnterLogicalOrExpr(ctx *LogicalOrExprContext) {}

// ExitLogicalOrExpr is called when production logicalOrExpr is exited.
func (s *BaseJLangListener) ExitLogicalOrExpr(ctx *LogicalOrExprContext) {}

// EnterLogicalAndExpr is called when production logicalAndExpr is entered.
func (s *BaseJLangListener) EnterLogicalAndExpr(ctx *LogicalAndExprContext) {}

// ExitLogicalAndExpr is called when production logicalAndExpr is exited.
func (s *BaseJLangListener) ExitLogicalAndExpr(ctx *LogicalAndExprContext) {}

// EnterBitOrExpr is called when production bitOrExpr is entered.
func (s *BaseJLangListener) EnterBitOrExpr(ctx *BitOrExprContext) {}

// ExitBitOrExpr is called when production bitOrExpr is exited.
func (s *BaseJLangListener) ExitBitOrExpr(ctx *BitOrExprContext) {}

// EnterBitXorExpr is called when production bitXorExpr is entered.
func (s *BaseJLangListener) EnterBitXorExpr(ctx *BitXorExprContext) {}

// ExitBitXorExpr is called when production bitXorExpr is exited.
func (s *BaseJLangListener) ExitBitXorExpr(ctx *BitXorExprContext) {}

// EnterBitAndExpr is called when production bitAndExpr is entered.
func (s *BaseJLangListener) EnterBitAndExpr(ctx *BitAndExprContext) {}

// ExitBitAndExpr is called when production bitAndExpr is exited.
func (s *BaseJLangListener) ExitBitAndExpr(ctx *BitAndExprContext) {}

// EnterEqualityExpr is called when production equalityExpr is entered.
func (s *BaseJLangListener) EnterEqualityExpr(ctx *EqualityExprContext) {}

// ExitEqualityExpr is called when production equalityExpr is exited.
func (s *BaseJLangListener) ExitEqualityExpr(ctx *EqualityExprContext) {}

// EnterRelationalExpr is called when production relationalExpr is entered.
func (s *BaseJLangListener) EnterRelationalExpr(ctx *RelationalExprContext) {}

// ExitRelationalExpr is called when production relationalExpr is exited.
func (s *BaseJLangListener) ExitRelationalExpr(ctx *RelationalExprContext) {}

// EnterShiftExpr is called when production shiftExpr is entered.
func (s *BaseJLangListener) EnterShiftExpr(ctx *ShiftExprContext) {}

// ExitShiftExpr is called when production shiftExpr is exited.
func (s *BaseJLangListener) ExitShiftExpr(ctx *ShiftExprContext) {}

// EnterAdditiveExpr is called when production additiveExpr is entered.
func (s *BaseJLangListener) EnterAdditiveExpr(ctx *AdditiveExprContext) {}

// ExitAdditiveExpr is called when production additiveExpr is exited.
func (s *BaseJLangListener) ExitAdditiveExpr(ctx *AdditiveExprContext) {}

// EnterMultiplicativeExpr is called when production multiplicativeExpr is entered.
func (s *BaseJLangListener) EnterMultiplicativeExpr(ctx *MultiplicativeExprContext) {}

// ExitMultiplicativeExpr is called when production multiplicativeExpr is exited.
func (s *BaseJLangListener) ExitMultiplicativeExpr(ctx *MultiplicativeExprContext) {}
...
// EnterMakeExpr is called when production makeExpr is entered.
func (s *BaseJLangListener) EnterMakeExpr(ctx *MakeExprContext) {}

// ExitMakeExpr is called when production makeExpr is exited.
func (s *BaseJLangListener) ExitMakeExpr(ctx *MakeExprContext) {}
